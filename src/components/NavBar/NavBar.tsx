...
const NavBar = () => {
  ...
  const linkedinRef = useRef<HTMLLIElement>(null);
  ...
  return (
    <div className={styles.container} ref={containerRef}>
      ...
      <div className={styles.testBackground}>{/* <TestEffect /> */}</div>

      <div className={styles.bar}></div>
      <ul className={styles.listContainer}>
        <li className={styles.listOption} ref={linkedinRef}>
        ...
        <li className={styles.listOption} ref={gitHubRef}>
          <a
            title="github"
